    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="statistics" mb="4" isInvalid={!!formik.errors?.statistics}>
            <FormLabel>Statistics</FormLabel>
            <Input type="text" name="statistics" value={formik.values?.statistics} onChange={formik.handleChange} />
            {formik.errors.statistics && <FormErrorMessage>{formik.errors?.statistics}</FormErrorMessage>}
          </FormControl>
